...
include "config.php";
    ...
    if (move_uploaded_file($tmp_name, $Location.$evidence)) {
        $sql = "UPDATE `incident` SET `sector`='$sector',`date`='$date',`type`='$type',`involved`='$involved',`des`='$des' `location`='$location',`casualties`='$casualties',`actions`='$actions',`entities`='$entities',`evidence`='$evidence' WHERE `ID`='$user_id'";
                         ...
                         <div class="col-md-8" style="margin-left: 20%;box-shadow:grey;">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                         <div class="col-md-10">
                                             <button name="update" class="btn btn-md btn-success col-md-12">Add Incident</button>
                                         </div>
                                    </div>
                                </form>
                            </div>
