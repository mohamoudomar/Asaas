...
if (move_uploaded_file($tmp_name, $Location.$evidence)) {
 $sql = mysqli_query($con,"INSERT INTO `operation` (`ID`, `sector`, `sdate`, `edate`, `commander`, `escort`, `type`, `des1`, `location`, `casualties`, `actions`,`entities`,`des`,`evidence`) VALUES (NULL, '$sector', '$sdate', '$edate', '$commander', '$escort','$type','$des1','$location','$casualties','$actions','$entities','$des','$evidence');");
 if ($sql) {
...
<head>
    ...
    <title>Asaas - operations report</title>
                                ...
                                <form method="POST" class="form-horizontal" enctype='multipart/form-data'>
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-5">State Operation Commander </label>
                                         <div class="col-md-10">
                                             <input type="text" name="commander" class="form-control">
                                         </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-5">Any Other Escorts </label>
                                         <div class="col-md-10">
                                             <input type="text" name="escort" class="form-control">
                                         </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                         <div class="col-md-10">
                                             <button name="Add" class="btn btn-md btn-success col-md-12">Add Operations</button>
                                         </div>
                                    </div>
                                </form>
                            </div>
