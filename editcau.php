...
$sql= "Select * from `caution` where ID=$ID";
...
if (move_uploaded_file($tmp_name, $Location.$evidence)) {
    $sql = mysqli_query($con,"UPDATE `caution` SET ID='$ID', sector='$sector', date='$date', name='$name', civil='$civil', phone='$phone', location='$location', reason='$reason', des='$des', entities='$entities', evidence='$evidence' WHERE ID = '$ID'");
 if ($sql) {
      
      echo "<script>alert('caution is succesfully Updated')</script>";
      header('location:Viewcaution.php');
  } 
  else{
    echo mysqli_error($con);
    echo "<script>alert('caution failed to Update')</scrip>";
    } 
  }
                     ...
                     <div class="row">
                         <div class="col-md-8" style="margin-left: 20%;box-shadow:grey;">
                            <div class="text  text-success panel-heading">
                                <h1 style="text-align: center;">Edit Caution Here</h1>
                            </div>
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                         <div class="col-md-10">
                                             <button name="Update" class="btn btn-md btn-success col-md-12">Update Caution</button>
                                         </div>
                                    </div>
                                </form>
                            </div>
