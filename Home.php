            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <!-- operations card -->
                        <div  href="operations.php" class="card-link" class="col-xl-3 col-md-6 mb-4">
...
<hr>
                        <!-- petrol card -->
                        <div  href="patrol.php" class="card-link" class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-primary shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
...
$query = "SELECT COUNT(*) FROM incident";
                        ...
                        <!-- casualties card -->
                        <div  href="casualties.php" class="card-link" class="col-xl-3 col-md-6 mb-4">
...
<hr>
                        ...
                        <!-- Caution card -->
                        <div  href="Caution.php" class="card-link" class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-warning shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                                Cautions</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">     <?php   include 'config.php';
$query = "SELECT COUNT(*) FROM caution";
                        $result = mysqli_query($con, $query) or die(mysqli_error($con));
                        while ($row = mysqli_fetch_array($result)) {
                            echo "$row[0]";
                          }
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                                Arrests</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">     <?php   include 'config.php';
$query = "SELECT COUNT(*) FROM arrest";
                        $result = mysqli_query($con, $query) or die(mysqli_error($con));
                        while ($row = mysqli_fetch_array($result)) {
                            echo "$row[0]";
                          }
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-primary">Charts</h1>
                        <a href="reportarrest.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                                class="fas fa-download fa-sm text-white-50"></i> Generate Report</a>
                    </div>
                        ...
                        <div class="col-xl-7 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary">choose chart</h6>
