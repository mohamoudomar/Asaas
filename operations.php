...
if (move_uploaded_file($tmp_name, $Location.$evidence)) {
 $sql = mysqli_query($con,"INSERT INTO `operation` (`ID`, `sector`, `date`, `edate`, `commander`, `escort`, `type`, `des1`, `location`, `casualties`, `actions`,`entities`,`des`,`evidence`) VALUES (NULL, '$sector', '$date', '$edate', '$commander', '$escort','$type','$des1','$location','$casualties','$actions','$entities','$des','$evidence');");
 if ($sql) {
      
      echo "<script>alert('operation is succesfully recorded')</script>";
      header('location:Viewoperations.php');
  } 
  else{
    echo mysqli_error($con);
    echo "<script>alert('operation is not succesfully recorded')</scrip>";
    } 
  }
...
<body id="page-top">
    ...
    <!-- End of Topbar -->
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-10 text-gray-800 alert alert-primary" style="text-align: center;">OPERATIONS REPORT</h1><br>
                     <div class="row">
                         <div class="col-md-8" style="margin-left: 20%;box-shadow:grey;">
                            <div class="text  text-success panel-heading">
                                <h1 style="text-align: center;">Add New Operations Here</h1>
                            </div>
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                    <label class="control-label col-md-5">Operation Type</label>
                                     <div class="col-md-10">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-2">Location</label>
                                         <div class="col-md-10">
                                         <textarea type="text" name="location" class="form-control"  rows ="3" cols="33"></textarea>
                                         </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                         <div class="col-md-10">
                                             <button name="Add" class="btn btn-md btn-success col-md-12" id="Add">Add Operations</button>
                                         </div>
                                    </div>
                                </form>
                            </div>
