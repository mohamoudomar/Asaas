...
<div class="text  text-success panel-heading">
                                <h1 style="text-align: center; color:#000;">Casualties Report</h1>
                            </div>
	<table class="table">
    <tr>    
...
$sql = mysqli_query($con,"SELECT * FROM casualties WHERE DATE BETWEEN '$startDate' AND '$endDate' ");
