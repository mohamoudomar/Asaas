...
if (move_uploaded_file($tmp_name, $Location.$evidence)) {
 $sql = mysqli_query($con,"INSERT INTO `caution` (`ID`, `sector`, `date`, `name`, `civil`, `phone`, `location`, `reason`, `des`, `entities`, `evidence`) VALUES (NULL, '$sector', '$date', '$name', '$civil' , '$phone', '$location','$reason','$des','$entities','$evidence');");
 if ($sql) {
      
      echo "<script>alert('caution is succesfully recorded')</script>";
      header('location:Viewcaution.php');
  } 
  else{
    echo mysqli_error($con);
    echo "<script>alert('caution is not succesfully recorded')</scrip>";
    } 
  }
...
<body id="page-top">
    ...
    <!-- End of Topbar -->
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-10 text-gray-800 alert alert-primary" style="text-align: center;">CAUTION REPORT</h1><br>
                     <div class="row">
                         <div class="col-md-8" style="margin-left: 20%;box-shadow:grey;">
                            <div class="text  text-success panel-heading">
                                <h1 style="text-align: center;">Add New Caution Here</h1>
                            </div>
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-6">Civilian Or Foreign</label>
                                     <div class="col-md-10">
                                         <select name="civil" class="form-control">
                                             <option style="color: red">Select If Civilian Or Foreign </option>
                                ...
                                <div class="form-group">
                                        <label class="control-label col-md-4">Phone Number of the Suspect</label>
                                         <div class="col-md-10">
                                         <textarea type="text" name="phones" class="form-control"  rows ="3" cols="33"></textarea>
                                         </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-4">Reason For The Caution</label>
                                     <div class="col-md-10">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-4">Details Of The Caution</label>
                                         <div class="col-md-10">
                                    ...
                                    <div class="form-group">
                                         <div class="col-md-10">
                                             <button name="Add" class="btn btn-md btn-success col-md-12">Add Caution</button>
                                         </div>
                                    </div>
                                </form>
                            </div>
